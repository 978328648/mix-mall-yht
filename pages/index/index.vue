<template>
	<view class="container">
		...
		<view class="cate-section">
			<view class="cate-item" v-for="(items,index) in sortList" :key="index">
		...
		<!-- 大活动图 -->
		<view class="ad-1">
			<image :src="`${imgUrl}${activityList[0].activity_url}`" mode="scaleToFill"></image>
		</view>
		...
		<view class="seckill-section m-t">
			...
			<scroll-view class="floor-list" scroll-x>
				<view class="scoll-wrapper">
					...
					>
						<image :src="`${imgUrl}${item.activity_url}`" mode="aspectFill"></image>
		...
		<view class="f-header m-t">
			...
			<view class="tit-box">
				...
				<text class="tit2">随便写点啥</text>
			</view>
			<!-- <text class="yticon icon-you"></text> -->
		</view>
		<view class="hot-floor"  v-for="item in sortList">
			<view class="floor-img-box">
				<image class="floor-img" :src="`${imgUrl}${activityList[0].activity_url}`" ></image>
			</view>
			<scroll-view class="floor-list" scroll-x>
				<view class="scoll-wrapper">
					<view 
		...
		<view class="guess-section">
			<view 
				v-for="(item, index) in ComListSon" :key="index"
				class="guess-item"
				@click="navToDetailPage(item)"
			>
				<view class="image-wrapper">
					<image :src="`${imgUrl}${item.product_img_list}`" mode="aspectFill"></image>
				</view>
				<text class="title clamp">{{item.product_name}}</text>
				<text class="price">￥{{item.product_price}}</text>
			</view>
