...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"yht","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 26 */
/*!***************************************!*\
  !*** E:/min-mall/mix-mall/pages.json ***!
  \***************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 27 */
/*!*******************************************!*\
  !*** E:/min-mall/mix-mall/store/index.js ***!
  \*******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 42 */
/*!*****************************************!*\
  !*** E:/min-mall/mix-mall/utils/api.js ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.IOSmfsy_ys = IOSmfsy_ys;
exports.addBookmark = addBookmark;
exports.addTest = addTest;
exports.alipayDealAction = alipayDealAction;
exports.asyncAuthenticate = asyncAuthenticate;
exports.batchDeleteBookmark = batchDeleteBookmark;
exports.bndsdxcx = bndsdxcx;
exports.bookCommentArray = bookCommentArray;
exports.bookCommentDetail = bookCommentDetail;
exports.bookFeePage = bookFeePage;
exports.bookSheetService = bookSheetService;
exports.dataIndexcb = dataIndexcb;
exports.dataIndexcb_ns = dataIndexcb_ns;
exports.dataIndexfl = dataIndexfl;
exports.dataIndexns = dataIndexns;
exports.dataIndexns_ys = dataIndexns_ys;
exports.dataIndexsd = dataIndexsd;
exports.dataIndexsd_ys = dataIndexsd_ys;
exports.dataIndextj = dataIndextj;
exports.dataIndextj_ys = dataIndextj_ys;
exports.dataIndexyc = dataIndexyc;
exports.dataIndexyc_ys = dataIndexyc_ys;
exports.downloadBoot = downloadBoot;
exports.getActivityList = getActivityList;
exports.getBanner = getBanner;
exports.getBookRankListByTabId = getBookRankListByTabId;
exports.getBookfeeInfo = getBookfeeInfo;
exports.getChapterOrFirendList = getChapterOrFirendList;
exports.getCharpterListAction = getCharpterListAction;
exports.getClassifyBookCondition = getClassifyBookCondition;
exports.getClassifyBookResultList = getClassifyBookResultList;
exports.getClassifyListConfigByTabId = getClassifyListConfigByTabId;
exports.getClientNavRankCatalogConfig = getClientNavRankCatalogConfig;
exports.getDetailCharpterList = getDetailCharpterList;
exports.getLatelyReadDataApi = getLatelyReadDataApi;
exports.getListTest = getListTest;
exports.getNodeBookList = getNodeBookList;
exports.getProductList = getProductList;
exports.getSearchBookResult = getSearchBookResult;
exports.getSearchHotWord = getSearchHotWord;
exports.getSearchRecommendWord = getSearchRecommendWord;
exports.getSeriesDetail = getSeriesDetail;
exports.getSortList = getSortList;
exports.getSubOperateResult = getSubOperateResult;
exports.getWorksList = getWorksList;
exports.iosmfsy = iosmfsy;
exports.login = login;
exports.makeBookPosterAction = makeBookPosterAction;
exports.markbook = markbook;
exports.mpgDown = mpgDown;
exports.orderedBooks = orderedBooks;
exports.orderedBooks_cs = orderedBooks_cs;
exports.pllb = pllb;
exports.receiveInvitationAction = receiveInvitationAction;
exports.searchSuggestion = searchSuggestion;
exports.search_ph_mon = search_ph_mon;
exports.search_ph_tot = search_ph_tot;
exports.search_ph_wk = search_ph_wk;
exports.search_rolebook = search_rolebook;
exports.senderInvitationAction = senderInvitationAction;
exports.seriesDetail = seriesDetail;
exports.setAutoSubSet = setAutoSubSet;
exports.updateBooksheet = updateBooksheet;
exports.updateTest = updateTest;
exports.wecharDetail = wecharDetail;
exports.wecharDetail_ys = wecharDetail_ys;
exports.wechat_booksheet = wechat_booksheet;
exports.wechat_chapterInfo = wechat_chapterInfo;
exports.wechat_isOrder = wechat_isOrder;
exports.wechat_sarch_cs = wechat_sarch_cs;
exports.wxAutoSubPage = wxAutoSubPage;
exports.wxGetWalletInfo = wxGetWalletInfo;
exports.wxGetWalletInfoYs = wxGetWalletInfoYs;
exports.wxRechargePage = wxRechargePage;
exports.wxRechargePage_cs = wxRechargePage_cs;
exports.wx_free_monthpack = wx_free_monthpack;
exports.wx_plxq = wx_plxq;
exports.wx_read_draw = wx_read_draw;
exports.wxauthorPage = wxauthorPage;
var _http = __webpack_require__(/*! ./http.js */ 43);
// 获取首页轮播图
...
//是否书籍是黑名单
function bookSheetService(data) {
  return (0, _http.http)({
...
//最后阅读信息
function getLatelyReadDataApi(data) {
  return (0, _http.http)({
...
//登录
function asyncAuthenticate(data) {
  return (0, _http.http)({
...
// 分享海报
function makeBookPosterAction(data) {
  return (0, _http.http)({
...
// 书友圈上拉刷新
function bookCommentArray(data) {
  return (0, _http.http)({
...
// 评论详情 上拉刷新
function bookCommentDetail(data) {
  return (0, _http.http)({
...
function wechat_chapterInfo(data) {
  return (0, _http.http)({
...
// 阅读页目录
function getCharpterListAction(data) {
  return (0, _http.http)({
...
// 详情页目录
function getDetailCharpterList(data) {
  return (0, _http.http)({
    url: '/nap/f/ms.content.wechatService/getCharpterListAction.json?',
    method: "POST",
    atType: "no",
...
// 充值选项列表-测试
function wxRechargePage_cs(data) {
  return (0, _http.http)({
...
// 查询充值是否成功
function alipayDealAction(data) {
  return (0, _http.http)({
...
// 查询订购是否成功
function getSubOperateResult(data) {
  return (0, _http.http)({
...
//   getPhoneNum 验收
function wxGetWalletInfoYs(data) {
  return (0, _http.http)({
...
//   书架列表
function wechat_booksheet(data) {
  return (0, _http.http)({
...
//   书架删除
function batchDeleteBookmark(data) {
  return (0, _http.http)({
...
//   书库tab列表
function getClientNavRankCatalogConfig(data) {
  return (0, _http.http)({
...
//   书库分类
function getClassifyListConfigByTabId(data) {
  return (0, _http.http)({
...
//   排行
function getBookRankListByTabId(data) {
  return (0, _http.http)({
...
//   书库列表
function getClassifyBookResultList(data) {
  return (0, _http.http)({
...
//   书库跳转书库列表
function getClassifyBookCondition(data) {
  return (0, _http.http)({
...
//   热搜
function getSearchHotWord(data) {
  return (0, _http.http)({
...
// 获取搜索默认词
function getSearchRecommendWord(data) {
  return (0, _http.http)({
...
// 搜索结果上拉加载
function getSearchBookResult(data) {
  return (0, _http.http)({
...
// 邀请阅读书籍列表
function senderInvitationAction(data) {
  return (0, _http.http)({
...
// 已邀请好友列表
function getChapterOrFirendList(data) {
  return (0, _http.http)({
...
// 助力
function receiveInvitationAction(data) {
  return (0, _http.http)({
...
// 下发激励奖励
function wx_free_monthpack(data) {
  return (0, _http.http)({
...
/* 43 */
/*!******************************************!*\
  !*** E:/min-mall/mix-mall/utils/http.js ***!
  \******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var http = function http(parapms) {
  var url = parapms.url,
    method = parapms.method,
    header = parapms.header,
    data = parapms.data,
    notForm = parapms.notForm,
    atType = parapms.atType;
  ...
  return new Promise(function (resolve, reject) {
    uni.request({
      ...
      success: function success(res) {
        ...
        var _loginErrorCode = res.header['X-Wechat-Login-Code'];
        var _loginErrorCodePc = res.header['x-wechat-login-code'];
        ...
        if (_loginErrorCode == '30019' || _loginErrorCodePc == '30019') {
          ...
          _store.default.commit('changeIsGetInfo', false);
        }
        resolve(res.data);
      },
